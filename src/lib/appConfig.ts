...
export const NETWORK_CONFIG: Record<string, NetworkConfig> = {
  mainnet: {
    ...
    vaultContract: 'CB4CEQW6W2HNVN3RA5T327T66N4DGIC24FONEZFKGUZVZDINK4WC5MXI',
  },
  testnet: {
    name: 'testnet',
...
export const getContractAddresses = (network: string = DEFAULT_NETWORK) => {
  ...
  if (network === 'testnet') {
    return {
      ...
      VAULT: config.vaultContract || 'CB4CEQW6W2HNVN3RA5T327T66N4DGIC24FONEZFKGUZVZDINK4WC5MXI',
      DEFINDEX_FACTORY: 'CD6MEVYGXCCUTOUIC3GNMIDOSRY4A2WGCRQGOOCVG5PK2N7UNGGU6BBQ',
      XLM_HODL_VAULT: 'CB4CEQW6W2HNVN3RA5T327T66N4DGIC24FONEZFKGUZVZDINK4WC5MXI',
